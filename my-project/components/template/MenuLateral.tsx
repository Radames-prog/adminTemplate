...
export default function MenuLateral(){
    return (
        <aside className={`flex flex-col dark:bg-gray-900 dark:text-gray-200 bg-gray-200 text-gray-900`}>
            ...
            <ul>
                <MenuItem onclick={() => console.log('logOut')} texto="Sair" icone={InconeSair} className={`text-red-600 hover:bg-red-400 hover:text-slate-200 dark:text-red-50 dark:hover:text-white`}/>
            </ul>
